...
.navbar{background:#1e3d8f;color:#fff;display:flex;align-items:center;padding:13px 50px;
  position:fixed;top:0;left:0;right:0;z-index:1000;gap:10px;box-shadow:0 4px 16px rgba(0,0,0,.2);}
...
/* ── PAGE ── */
.page-wrap{max-width:980px;margin:100px auto 60px;padding:0 24px;}
...
<main class="page-wrap">
  ...
  <div class="laporan-list">
    ...
    <?php else: foreach ($laporan as $r):
      $foto = (!empty($r['foto_awal']) && file_exists('../' . $r['foto_awal'])) ? htmlspecialchars('../' . $r['foto_awal']) : '../ASSETS/rusak 1.jpeg';
      $st   = $r['status'];
    ?>
