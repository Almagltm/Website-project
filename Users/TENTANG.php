...
.user {
    ...
    .section-title { font-weight: bold; font-size: 14px; margin-bottom: 6px; text-align: left; }
...
<body>
  ...
  <div id="logoutPopup" class="popup">
    <div class="popup-box">
      ...
      <p>Keluar dari AksiKita sebagai <b><?php echo htmlspecialchars($nama); ?></b>?</p>

      <div class="popup-actions">
        <button id="confirmLogout" onclick="location.href='logout.php'">Iya</button>
