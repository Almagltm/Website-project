...
.laporan-page {
    max-width: 950px;
    /* Konsisten: Margin 120px untuk mengimbangi fixed navbar */
...
<body>
    ...
    <div class="notfound-container">
        ...
        <p class="notfound-desc">
            Silakan masuk atau buat akun baru untuk mengakses fitur laporan.
        </p>
