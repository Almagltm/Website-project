...
<head>
  ...
  <title>Beranda - Aksi Kita</title>
  <link rel="preconnect" href="https://fonts.googleapis.com">
  <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
  <link href="https://fonts.googleapis.com/css2?family=BBH+Sans+Bartle&family=Lobster+Two:ital,wght@0,400;0,700;1,400;1,700&family=Monoton&family=Niconne&family=Noto+Sans+JP:wght@100..900&family=Roboto:ital,wght@0,100..900;1,100..900&display=swap" rel="stylesheet">
...
.popup-box {
  ...
  padding: 25px 30px;
  width: 330px;
  border-radius: 50px 0 50px 0;   /* border radius gaya desainmu */
...
<body>
  ...
  <section class="hero">
    ...
    <div class="hero-text">
      <h1>
        MARI BERKONTRIBUSI <br>
        DEMI KEBAIKAN <br> INDONESIA
      </h1>

      <button class="laporkan-btn" id="laporkanBtn">LAPORKAN</button>
    </div>
  </section>
  ...
  <div class="about-container">
    ...
    <p>
      AksiKita adalah platform pelaporan publik yang membantu masyarakat 
  ...
  <div id="popup-overlay" class="popup-overlay">
    <div class="popup-box">
      <p>
        Wah, sepertinya Anda belum masuk.<br>
        Silakan masuk terlebih dahulu untuk dapat menggunakan fitur ini.
      </p>
    </div>
  </div>
...
<div class="showcase-text">
  ...
  <p>
    Aksi Kita adalah platform pelaporan publik modern yang memberikan ruang 
...
<script>
  ...
  const btn = document.getElementById("laporkanBtn");

  // Ketika tombol LAPORKAN diklik → tampilkan popup
  btn.addEventListener("click", () => {
    popup.style.display = "flex";
  });

  // Klik area luar popup → hilang
