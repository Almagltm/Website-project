<?php
/**
 * Statistika.php - Admin Statistik Laporan
 * Halaman statistik untuk admin yang menggunakan data dari STATISTIK.php
 */
...
<title>Statistika Laporan – Aksi Kita</title>
...
<header class="topbar">
    <div class="topbar-left">
        <a href="Beranda_Admin.php" class="back-btn"><i class="fa-solid fa-chevron-left"></i></a>
        <h1>Statistika Laporan</h1>
    </div>
...
<div class="page-wrap">
    ...
    <div class="table-card">
        <div class="card-header" style="margin-bottom:0;padding-bottom:16px;">
            ...
            <a href="Kelola_Laporan.php" style="font-size:12px;color:var(--blue-mid);font-weight:600;display:flex;align-items:center;gap:4px;">
